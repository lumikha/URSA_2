...
<div class="account_tab" style="margin-top:-54px; margin-left: ">
    <div class="grid_10 push_2 text-center">
        <div class="cust_id grid_2 alpha" style="padding: 1em;margin-bottom:1em;border:solid black 2px;"><strong><?php if($chargifyID){ echo $chargifyID; }else{ echo "Chargify ID"; }?></strong></div>
        <div class="bill_sum grid_2" style="padding: 1em;margin-bottom:1em;border:solid black 2px;"><strong><?php if($billing_sum){ echo $billing_sum; }else{ echo "Billing Sum"; }?></strong></div>
        <div class="last_activity grid_2" style="padding: 1em;margin-bottom:1em;border:solid black 2px;"><strong><?php if($char_upd_at){ echo $char_upd_at; }else{ echo "Last Activity"; }?></strong></div>
        <div class="grid_2" style="padding: 1em;margin-bottom:1em;border:solid #A60800 2px;color:#A60800"><strong>Ticket</strong></div>
        <div class="grid_2 omega" style="padding: 1em;margin-bottom:1em;border:solid #340570 2px;color:#340570"><strong>Talkdesk</strong></div>
        <div class="row">
        </div>
    </div>
    ...
    <div class="tab-pane fade" id="account" style="margin-top: -5em;">
